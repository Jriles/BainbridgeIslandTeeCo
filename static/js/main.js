...
function checkDesignSizeInventory(product_element_id){
    ...
    var current_size_drop_down = $(current_product).find("t-shirt-size" + current_design_index);
    console.log("current drop down children length: " + $(current_size_drop_down).children().length);
